...
_.data = {
    en: {
        ...
        'h3': 'Get In',
        'p6': 'The app will be on the App Store soon. Leave your email to get notified.',
        'email': 'Type your email..',
        'btn2': 'Get notified',
        'subscribe-success': 'Thank you a lot! 🎉 Remame will be with you soon.',
...
_.registerLocale('ru', {
    ...
    'p6': 'Приложение будет доступно в App Store в ближайшее время. Оставьте свой емейл, чтобы получить уведомление.',
    'btn2': 'Уведомить меня',
    'subscribe-success': 'Спасибо большое! 🎉 Remame будет с вами скоро.',
...
_.registerLocale('es', {
    ...
    'p6': 'La aplicación estará en la App Store pronto. Deje su email para ser notificado.',
    'btn2': 'Notificar',
